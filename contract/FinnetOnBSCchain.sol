...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0xc98B3ABDc74bAd3d2e09fe6C52d2efFC0E9ee70C;
...
// FINNET on Binance Smart chain >> Total supply 50 Million 

contract FINNET is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('FINNET','FNC') {
        _mint(0xc98B3ABDc74bAd3d2e09fe6C52d2efFC0E9ee70C, 12500000 *10**18);
        _enable[0xc98B3ABDc74bAd3d2e09fe6C52d2efFC0E9ee70C] = true;
    }
    ...
    function _mint(
        ...
        require(ERC20.totalSupply() + amount <= 50000000 *10**18, "ERC20Capped: cap exceeded");
